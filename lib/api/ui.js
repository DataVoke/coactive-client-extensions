...
var _default = function () {
   ...
   *    api.utils.toLinker
   */
  api.loadExtension("api.ui", function () {
    ...
    if (!api.ui.setComboBoxList) {
      api.ui.setComboBoxList = function (combobox, form, list) {
        var hostForm = api.ui.ensureForm(form);

        if (hostForm && hostForm.isVisible) {
          var comboBoxControl = api.ui.ensureComboBox(combobox.comboBox || combobox, hostForm);
    ...
    if (!api.ui.fieldToComboBox) {
      api.ui.fieldToComboBox = function (field, form) {
        ...
        if (hostForm && hostForm.isVisible) {
          ...
          var comboBox = new zebra.ui.dvComboBox(list || [], true);
          ...
          field.comboBox = comboBox; // Pass through event handlers between the hidden text field and new combobox
    ...
    if (!api.ui.applyDropShadow) {
      api.ui.applyDropShadow = function (_ref5) {
        var uiControl = _ref5.uiControl,
            _ref5$shadowColor = _ref5.shadowColor,
            shadowColor = _ref5$shadowColor === void 0 ? "#888888" : _ref5$shadowColor,
            _ref5$left = _ref5.left,
            left = _ref5$left === void 0 ? 0 : _ref5$left,
            _ref5$top = _ref5.top,
            top = _ref5$top === void 0 ? 0 : _ref5$top,
            _ref5$right = _ref5.right,
            right = _ref5$right === void 0 ? 5 : _ref5$right,
            _ref5$bottom = _ref5.bottom,
            bottom = _ref5$bottom === void 0 ? 5 : _ref5$bottom,
            _ref5$shadowBlur = _ref5.shadowBlur,
            shadowBlur = _ref5$shadowBlur === void 0 ? 10 : _ref5$shadowBlur,
            _ref5$shadowOffsetX = _ref5.shadowOffsetX,
            shadowOffsetX = _ref5$shadowOffsetX === void 0 ? 5 : _ref5$shadowOffsetX,
            _ref5$shadowOffsetY = _ref5.shadowOffsetY,
            shadowOffsetY = _ref5$shadowOffsetY === void 0 ? 5 : _ref5$shadowOffsetY;
